...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_range_set_range_composite.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/range_set_range_composite\"\n#line\
    \ 2 \"structure/lazysegtree.hpp\"\n#include <bits/stdc++.h>\nusing namespace std;\n\
    ...
    \ (int i = 0; i < Q; i++) {\n    int t;\n    cin >> t;\n    if (t == 0) {\n  \
    \    int l, r;\n      long long c, d;\n      cin >> l >> r >> c >> d;\n      seg.apply(l,\
    \ r, F{aff(mint(c), mint(d)), true});\n    } else {\n      int l, r;\n      long\
    \ long x;\n      cin >> l >> r >> x;\n      S res = seg.prod(l, r);\n      mint\
    \ ans = res.f.eval(mint(x));\n      cout << ans.v << \"\\n\";\n    }\n  }\n  return\
    \ 0;\n}\n"
...
layout: document
redirect_from:
- /verify/verify/yosupo_range_set_range_composite.test.cpp
- /verify/verify/yosupo_range_set_range_composite.test.cpp.html
